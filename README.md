...
- 1) One octave limitation
  - User may choose from a set of 8 possible notes (as shown in the image below) that is represented in code like this: g, a, b, c', d', e', f', g'
